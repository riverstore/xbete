...
const string bts_banned_client = "this client is banned in TT4XBT Tracker";
...
const string bts_completed_at = "completed at";
...
const string bts_started_at = "started at";
